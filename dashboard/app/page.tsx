  ...
  return (
    <main className="min-h-screen bg-slate-50 p-6 md:p-10 font-sans text-slate-900">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <header className="border-b border-slate-200 pb-8 pt-4">
          <h1 className="text-3xl font-semibold tracking-tight text-slate-900 mb-2">
            Sub-word Tokenization Project
          </h1>
          <p className="text-slate-500 text-lg">
            Complete Evaluation and Explainability Dashboard (Parts 1-6)
          </p>
        </header>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <section className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
            <h2 className="text-lg font-semibold text-slate-800 mb-6 tracking-wide">
              Part 1: BPE Performance Metrics
            </h2>
          ...
          <section className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
            <h2 className="text-lg font-semibold text-slate-800 mb-6 tracking-wide">
              Part 3: Linguistic Fairness Audit
            </h2>
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left">
                <thead className="bg-slate-50 text-slate-600 font-medium border-b border-slate-200">
                ...
                <tbody className="divide-y divide-slate-100">
                  {reports.fairness.map((row: any, i: number) => (
                    <tr key={i} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className={`p-3 font-medium ${row["Tokens/Word"] > 2.0 ? "text-rose-600" : "text-emerald-700"}`}>
                        {row["Tokens/Word"]}
                      </td>
        ...
        <section className="bg-white p-8 rounded-xl shadow-sm border border-slate-200">
          <header className="mb-8">
            <h2 className="text-xl font-semibold text-slate-800 mb-2">Part 6: Multi-Model Alignment Visualizer</h2>
          ...
          <div className="flex flex-col md:flex-row gap-4 mb-10">
            <input
              type="text"
              className="flex-1 p-4 bg-slate-50 border border-slate-300 rounded-lg focus:ring-1 focus:ring-slate-400 outline-none text-base text-slate-700 transition-shadow"
              value={inputText}
            ...
            <button
              ...
              disabled={loading}
              className="bg-slate-800 text-white px-8 py-4 rounded-lg font-medium hover:bg-slate-700 transition-colors disabled:opacity-50 whitespace-nowrap shadow-sm"
            >
