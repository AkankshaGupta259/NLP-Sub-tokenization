...
class BPETokenizer:
    ...
    def train(self, corpus_text, target_vocab_size):
        ...
        print(f"  -> Base character vocabulary size: {self.base_vocab_size}")
        ...
        # Generate ranks directly after training so encode() works
    ...
    def encode(self, text):
        ...
        for word in words:
            ...
            while len(word_symbols) > 1:
                ...
                pair_to_merge = min(valid_pairs, key=lambda p: self.bpe_ranks[p])
